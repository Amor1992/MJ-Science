...
- **[力与运动基础](physics/forces-motion.html)** ⭐⭐⭐（开发中）
  - 拔河比赛：调整双方人数和推力
  - 推箱子：施加推力，观察摩擦力效果
  - 实时速度表、力度表显示
...
- **[分数配对](mathematics/fraction-matcher.html)** ⭐⭐⭐（开发中）
  - 配对相同大小的分数图形或数字
  - 8个难度等级
  - 学习等价分数：1/2 = 2/4 = 3/6
...
#### ⚡ 电学实验
- **[气球与静电](electricity/balloons-static.html)** ⭐⭐（开发中）
  - 拖拽气球在毛衣上摩擦产生静电
  - 观察气球吸引墙壁或排斥其他气球
  - 微观视角：电子转移过程
  - 学习同种电荷相斥、异种电荷相吸
...
#### 🧊 物质科学
- **[物质状态基础](matter/states-of-matter.html)** ⭐⭐⭐（开发中）
  - 观察物质在固态、液态、气态下的行为
  - 调节温度，观察状态变化
  - 微观视角：原子/分子运动和排列方式
